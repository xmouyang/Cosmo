...
from cmc_model import MyUTDModelFeature
from cmc_design import FeatureConstructor, CMCLoss
...
def parse_option():
    ...
    # method
    parser.add_argument('--method', type=str, default='CMC',
                        choices=['ConFusion', 'CMC'], help='choose method')
    ...
    opt.model_path = './save/CMC/{}_models'.format(opt.dataset)
    opt.tb_path = './save/CMC/{}_tensorboard'.format(opt.dataset)
